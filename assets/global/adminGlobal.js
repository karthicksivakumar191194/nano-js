...
! function(t, e) {
        ...
        _setActiveIndicatorElement(e) {
            if (this._indicatorsElement) {
                ...
                for (let t = 0; t < n.length; t++)
                    if (Number.parseInt(n[t].getAttribute("data-coreui-slide-to"), 10) === this._getItemIndex(e)) {
    ...
    class $t extends B {
        ...
        _getConfig(t) {
            return (t = {
                ...wt,
                ...t
            }).toggle = Boolean(t.toggle), l(vt, t, Et), t
        }
        _getDimension() {
    ...
    class Bi extends B {
        ...
        _getConfig(t) {
            if (t = {
                    ...
                    ...V.getDataAttributes(this._element),
                    ...t
                }, l(fi, t, this.constructor.DefaultType), "object" == typeof t.reference && !r(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError(`${fi.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
            return t
        }
        _getMenuElement() {
    ...
    class Yi {
        ...
        _getConfig(t) {
            return (t = {
                ...Ui,
                ..."object" == typeof t ? t : {}
            }).rootElement = a(t.rootElement), l(Vi, t, zi), t
        }
        _append() {
    ...
    class dn extends B {
        ...
        show(t) {
            ...
            j.trigger(this._element, en, {
                relatedTarget: t
            }).defaultPrevented || (this._isShown = !0, this._isAnimated() && (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(ln), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), j.on(this._element, on, '[data-coreui-dismiss="modal"]', (t => this.hide(t))), j.on(this._dialog, an, (() => {
        ...
        _showElement(e) {
            ...
            this._queueCallback((() => {
                this._config.focus && this._element.focus(), this._isTransitioning = !1, j.trigger(this._element, "shown.coreui.modal", {
                    relatedTarget: e
                })
            }), this._dialog, i)
        }
    ...
    class xs extends B {
        ...
        _getConfig(t) {
            return (t = {
                ...
                ...V.getDataAttributes(this._element),
                ..."object" == typeof t && t ? t : {}
            }).target = a(t.target) || document.documentElement, l(_s, t, ys), t
        }
        _getScrollTop() {
    ...
    class Gs extends B {
        ...
        show() {
            ...
            const o = e ? j.trigger(e, "hide.coreui.tab", {
                relatedTarget: this._element
            }) : null;
    ...
    class go extends B {
        ...
        _getConfig(t) {
            return t = {
                ...
                ...V.getDataAttributes(this._element),
                ..."object" == typeof t && t ? t : {}
            }, l(Zs, t, this.constructor.DefaultType), t
        }
        _maybeScheduleHide() {
